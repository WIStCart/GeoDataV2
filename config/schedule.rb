...
# IMPORTANT!  Our servers are all running on UTC, no timezone is set! 
# times below are UTC.  Conversion: -5 during CDT, -6 during CST
...
every :day, at: '7:05am', roles: [:app] do
